...
<video width="100%" autoplay="" loop="" muted="" style="display: block; margin-left: auto; margin-right: auto; width: 100%;">
...
<img src="./media/finding_nemo.gif" width="50%" alt="Finding Nemo Gif" style="display: block; margin-left: auto; margin-right: auto; width: 50%;">
...
<img src="./media/fish_logo.png" width="50%" alt="RIT Logo but Fish" style="display: block; margin-left: auto; margin-right: auto; width: 50%;">
...
<img src="./media/boids_rules.png" width="50%" alt="Boid Rules" style="display: block; margin-left: auto; margin-right: auto; width: 50%;">
...
<img src="./media/fish_a.png" width="50%" alt="Fish Making an A" style="display: block; margin-left: auto; margin-right: auto; width: 50%;">
...
<img src="./media/boid_y_diagram.svg" width="50%" alt="Bounding Box Algorithm Diagram" style="display: block; margin-left: auto; margin-right: auto; width: 50%;">
...
<img src="./media/trout_model.jpg" width="50%" alt="Fish Model" style="display: block; margin-left: auto; margin-right: auto; width: 50%;">
...
<video width="50%" autoplay="" loop="" muted="" style="display: block; margin-left: auto; margin-right: auto; width: 50%;">
...
<img src="./media/spinning_fish.gif" width="10%" alt="Thanks for Reading!" style="display: block; margin-left: auto; margin-right: auto; width: 10%;">
